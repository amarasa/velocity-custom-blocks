<section class="recent-posts pt-8 pb-24 recent-posts-2">
    <div class="lg:container px-8">
        ...
        <div class="text-center">
            <?php $recent_posts_link = get_field('blog_link'); ?>
            <?php if ($recent_posts_link) { ?>
                <a href="<?php echo $recent_posts_link['url']; ?>" class="font-bold text-lg"><?php echo $recent_posts_link['title']; ?></a>
            <?php } ?>
        </div>
    </div>
</section>