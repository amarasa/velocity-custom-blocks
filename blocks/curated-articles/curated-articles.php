<div class="md:container px-8 py-8 md:py-16">
    <h2 class="text-2xl md:text-[32px] font-bold text-center mb-7 md:mb-[34px]"><?php echo get_field(
                                                                                    "headline"
                                                                                ); ?></h2>

    <?php $recent_articles_or_hand_picked = get_field(
        "recent_articles_or_hand_picked"
    ); ?>

    <div class="grid grid-cols-12 md:gap-x-[30px]">
        <?php if ($recent_articles_or_hand_picked) { ?>
            <?php $hand_pick_articles = get_field("hand_pick_articles"); ?>
            <?php foreach ($hand_pick_articles as $hand_picked_post) :
